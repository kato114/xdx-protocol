...
const AVALANCHE = 43113;

const { AVALANCHE_URL, AVALANCHE_DEPLOY_KEY } = require("../../env.json");

const providers = {
  avalanche: new ethers.providers.JsonRpcProvider(AVALANCHE_URL),
};

const signers = {
  avalanche: new ethers.Wallet(AVALANCHE_DEPLOY_KEY).connect(
    providers.avalanche
  ),
};
