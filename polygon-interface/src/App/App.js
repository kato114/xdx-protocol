...
function FullApp() {
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>, and use $XDX with its built-in
              browser
            </Trans>
          ) : (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink> to start using $XDX
            </Trans>
          )}
        </div>
      );
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>, and use XDX
  ...
  return (
    <>
      <div className={`App ${location.pathname === "/trade" ? "on-trade" : ""}`}>
