  ...
  return (
    <div className="ExchangeBanner">
      <p className="ExchangeBanner-text">
        <Trans>
          Trade on $XDX and win <span className="ExchangeBanner-price">$250.000</span> in prizes! Live until November
          30th,{" "}
          <ExternalLink
            href="https://xdx.medium.com//xdx-trading-competition-win-250-000-usd-in-prizes-1346504b96f6"
