...
export default function SwapBox(props) {
  ...
  const getLeaderboardLink = () => {
    if (chainId === ARBITRUM) {
      return "https://www.xdx.house/arbitrum/leaderboard";
    }
    if (chainId === AVALANCHE) {
      return "https://www.xdx.house/avalanche/leaderboard";
    }
    return "https://www.xdx.house";
  };
        ...
        {isStopOrder && (
          <div className="Exchange-swap-section Exchange-trigger-order-info">
            <Trans>
              ...
              <ExternalLink href="https://xdx.gitbook.io/xdx/trading#stop-loss-take-profit-orders">docs</ExternalLink>.
            </Trans>
          </div>
        )}
                  ...
                  return (
                    <div>
                      <Trans>
                        ...
                        <br />
                        <br />
                        <ExternalLink href="https://xdx.gitbook.io/xdx/trading#opening-a-position">
                          More Info
                        </ExternalLink>
                      </Trans>
                    </div>
      ...
      {/* <div className="Exchange-swap-market-box App-box App-box-border">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="https://xdx.gitbook.io/xdx/trading">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="https://xdx.gitbook.io/xdx/trading#backup-rpc-urls">
