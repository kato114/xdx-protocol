...
import { USD_DECIMALS, SWAP, INCREASE, CHART_PERIODS, CHART_TYPES, getLiquidationPrice } from "lib/legacy";
    ...
    <div className="ExchangeChart tv" ref={ref}>
      <div className="ExchangeChart-top App-box App-box-border">
        <div className="ExchangeChart-top-inner">
          <div>
            <div
              className="ExchangeChart-title d-flex align-items-center"
              style={{ margin: "0px 15px 0px 5px", gap: "5px" }}
            >
              <img src={chartToken.imageUrl} width="20px" />
        ...
        <div className="ExchangeChart-top-type">
          <Tab options={Object.keys(CHART_TYPES)} option={chartType} setOption={setChartType} />
        </div>
      </div>
      <div className={`ExchangeChart-bottom App-box App-box-border ${chartType === "BASIC" ? "d-block" : "d-none"}`}>
      ...
      <div className={`ExchangeChart-bottom App-box App-box-border ${chartType === "PRO" ? "d-block" : "d-none"}`}>
        <AdvancedChart widgetProps={{ theme: "dark", symbol: `BINANCE:${chartToken.symbol}USD` }} />
      </div>
    </div>
  );
}
