...
function shouldSwap(collateralToken, receiveToken) {
  ...
  // @see https://github.com/MinMax-Dex/xdx-interface/blob/master/src/pages/Exchange/Exchange.js#L162
        ...
        return (
          <div className="Confirmation-box-warning">
            <Trans>
              ...
              <ExternalLink href="https://xdx.gitbook.io/xdx/trading#minimum-price-change">
                pending profit
              </ExternalLink>{" "}
              of {deltaStr}. <br />
            </Trans>
                  ...
                  renderContent={() => (
                    <div>
                      ...
                      <div className="PositionSeller-fee-item">
                        <Trans>
                          <ExternalLink href="https://xdx.gitbook.io/xdx/trading#fees">
                            More Info
                          </ExternalLink>{" "}
                          about fees.
                        </Trans>
