...
export function RedirectPopupModal({
  ...
  return (
    <Modal
      ...
      label={t`Launch App`}
    >
      <Trans>You are leaving $XDX.io and will be redirected to a third party, independent website.</Trans>
      <br />
      <br />
      <Trans>
        The website is a community deployed and maintained instance of the open source{" "}
        <ExternalLink href="https://github.com/xdxprotocol">$XDX front end</ExternalLink>, hosted and
      ...
      <Trans>
        ...
        <ExternalLink href="https://xdx.gitbook.io/xdx/app-links">docs</ExternalLink>.
        <br />
        <br />
        By clicking Agree you accept the{" "}
        <ExternalLink href="https://app.xdx.exchange/#/terms-and-conditions">T&Cs</ExternalLink> and{" "}
        <ExternalLink href="https://app.xdx.exchange/#/referral-terms">Referral T&Cs</ExternalLink>.
        <br />
        <br />
      </Trans>
      <div className="mb-sm">
