  ...
  return (
    <div className="Migration Page">
      ...
      <div className="Migration-note">
        <Trans>Your wallet: {formatAmount(xdxBalance, 18, 4, true)}</Trans> $XDX
      </div>
      <div className="Migration-note">
        <Trans>
          Please read the{" "}
          <ExternalLink href="https://gambitprotocol.medium.com/gambit-xdx-migration-now-live-2ba999d208dd">
            Medium post
          </ExternalLink>{" "}
          before migrating.
        </Trans>
