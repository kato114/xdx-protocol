        ...
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            ...
            <div className="Page-description">
              <Trans>Job openings at $XDX.</Trans>
            </div>
          </div>
        </div>
...
function NoJob() {
  return (
    <Card title={t`No open positions at $XDX currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            $XDX is not actively looking for new hires at the moment. However, if you think you can contribute to the
            project, please email <ExternalLink href="mailto:jobs@xdx.io">jobs@xdx.io</ExternalLink>.
          </Trans>
        </p>
      </div>
    </Card>
...
//         <ul>
//           <li>Work closely with the $XDX team on the $XDX front-end website.</li>
...
//           </ul>
//           <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 $XDX a year.</p>
