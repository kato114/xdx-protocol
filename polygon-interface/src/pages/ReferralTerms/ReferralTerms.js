      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">$XDX Referral Program</div>
          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                $XDX Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct
                Referral Code. You may promote the $XDX Protocol offers in any manner you choose unless it misleads
                someone about the $XDX Protocol.
              </p>
              <p className="body-text">
                2.2 XDX.exchange is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any
            ...
            <div className="section">
              ...
              <p className="body-text">
                XDX.exchange is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and
                Discounts are handled following the directives of the $XDX tokenholders.
              </p>
              <p className="body-text">
                ...
                <a
                  ...
                  href="https://xdx.gitbook.io/xdx/how-it-works/referrals"
                >
                  https://xdx.gitbook.io/xdx/how-it-works/referrals.
                </a>
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall XDX.exchange be liable for any direct, indirect, incidental, punitive,
              ...
              <p className="body-text">
                In no event shall XDX.exchange's aggregate liability arising out of or in connection with the Site
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by XDX.exchange, or your use of the service(s) provided by XDX.exchange,
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from XDX.exchange, which the token holders of $XDX determine.
              ...
              <p className="body-text">
                XDX.exchange will not be liable for any losses suffered by you resulting from any modification to the
              ...
              <p className="body-text">
                XDX.exchange may revise these Terms from time to time. We will notify you by updating the date at the
                top of the Terms and maintaining a current version. The most current version of the Terms will always be
                at https://app.xdx.exchange/#/referral-terms. All modifications will be effective when they are
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and XDX.exchange concerning the subject matter of these Terms and
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. XDX.exchange will amend or replace such provision with one that
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. XDX.exchange may assign or transfer any or all of our
                rights or obligations under these Terms, in whole or part, without notice or obtaining your consent or
                approval.
              </p>
              <p className="body-text">
                8.6 XDX.exchange will have no responsibility or liability for any failure or delay in performance of
