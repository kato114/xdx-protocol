...
export default function ClaimEsXDX({ setPendingTxns }) {
  ...
  const arbVesterAdddresses = [getContract(ARBITRUM, "XDXVester"), getContract(ARBITRUM, "XLXVester")];
  ...
  if (selectedOption === VEST_WITH_XLX_ARB && arbVestingData) {
    const result = getVestingValues({
      ...
      amount,
      vestingDataItem: arbVestingData.xlxVester,
    });
  ...
  if (selectedOption === VEST_WITH_XLX_AVAX && avaxVestingData) {
    const result = getVestingValues({
      minRatio: bigNumberify(320),
      amount,
      vestingDataItem: avaxVestingData.xlxVester,
    });
          ...
          <div>
            <div className="Page-description">
              ...
              <Trans>
                ...
                <ExternalLink href={`https://arbiscan.io/token/${esXDXIouAddress}?a=${account}`}>here</ExternalLink>.
              </Trans>
            </div>
            <br />
            ...
            <div>
              <div className="ClaimEsXDX-input-label muted">
