      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">$XDX</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to XDX.exchange ("we," "us," or "our"), the informational resource for $XDX Protocol, as
                defined below.
              </p>
              <p className="body-text">
                XDX.exchange provides information and resources about the fundamentals of the decentralized
                non-custodial protocol called the $XDX Protocol (the "$XDX Protocol," "Protocol," or "$XDX DApp").
                XDX.exchange is not an available access point to the $XDX Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access XDX.exchange ("the Site") and app.XDX.exchange ("the
            ...
            <div className="section">
              ...
              <p className="body-text">The XDX.exchange site is for informational purposes only.</p>
              <p className="body-text">
                XDX.exchange is not part of any transaction on the blockchain networks underlying the $XDX Protocol;
                ...
                receive any crypto assets. You understand that when you interact with any $XDX Protocol smart contracts,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over XDX.exchange or you as otherwise duly
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that XDX.exchange or any of its suppliers or contractors may undertake
                        from time to time; (c) causes beyond XDX.exchange's control or that XDX.exchange could not
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with XDX.exchange;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. XDX.exchange does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. XDX.exchange does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. XDX.exchange own all rights, names, logos, and other marks used on the Site and the
                    ...
                    the $XDX Protocol and the Interface (xdx.exchange) deployed on IPFS is open-sourced. Except as
                ...
                <li>
                  <p className="body-text">
                    4.2. XDX.exchange may use and share your comments, bug reports, ideas, or other feedback that you
                    may provide, including suggestions about how we might improve. You agree that XDX.exchange is
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. XDX.exchange reserve the right, at our sole discretion, from time to time and with or
                    ...
                    do not host or own its code. XDX.exchange will not be liable for any losses suffered by you
                ...
                <li>
                  <p className="body-text">
                    5.2. XDX.exchange may revise these Terms from time to time. We will notify you by updating the
                    date at the top of the Terms and maintaining a current version. The most current version of the
                    Terms will always be at https://app.xdx.exchange/#/terms-and-conditions. All modifications will
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. XDX.exchange does not
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That XDX.exchange is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither XDX.exchange nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. XDX.exchange is not responsible for the content of any third party, including, but not
                    limited to, information, materials, products, or services that XDX.exchange does not own or
                    control. In addition, third parties may offer promotions related to your access and use of the
                    Interface. XDX.exchange does not endorse or assume any responsibility for such resources or
                    ...
                    relationships with any third parties. You expressly relieve XDX.exchange of all liability arising
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that XDX.exchange will have no responsibility or liability for
                    the risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether
                    known or unknown to you, against XDX.exchange, its affiliates, and their respective shareholders,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of XDX.exchange;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including XDX.exchange's collaborator
            ...
            <div className="section">
              ...
              <p className="body-text">
                XDX.exchange is an informational site for the $XDX Protocol. XDX.exchange does not operate an
              ...
              <p className="body-text">
                You understand that XDX.exchange is not registered or licensed by any regulatory agency or authority.
              ...
              <p className="body-text">
                ...
                XDX.exchange makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall XDX.exchange, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of XDX.exchange, whether under contract,
                ...
                Terms or any limited remedy hereunder nor is XDX.exchange in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall XDX.exchange's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless XDX.exchange, its affiliates, members, member,
            ...
            <div className="section">
              ...
              <p className="body-text">
                XDX.exchange will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to XDX.exchange on any of our official channels. The notice must (a) describe the
                nature and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be
                similar in form to that described above. If you and XDX.exchange cannot reach an agreement to resolve
                the claim within sixty (60) days of your email, then you and XDX.exchange agree to resolve the
              ...
              <p className="body-text">
                ...
                XDX.exchange will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of XDX.exchange set forth in these Terms is in addition to, and not in
                    lieu of, any other right or remedy whether described in these Terms, under Applicable Law, at law,
                    or in equity. The failure or delay of XDX.exchange in exercising any right, power, or privilege
                ...
                <li>
                  <p className="body-text">
                    13.4. XDX.exchange will have no responsibility or liability for any failure or delay in
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and XDX.exchange and supersede all
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                XDX.exchange on any of our official channels.
              </p>
            </div>
          </div>
        </div>
