    ...
    <div className="Exchange page-layout">
      ...
      <div className="Exchange-content">
        ...
        <div className="Exchange-right">
          <div className="tk-select-box">
            {!active ? (
              <div className="tk-select-alert">
              ...
              <>
                ...
                {/* <button className="tk-select-btn" onClick={chooseSelector}>
                  ...
                  <div>
                    {selector ? <img src={arrowUpIcon} width="15px" /> : <img src={arrowDownIcon} width="15px" />}
                  </div>
                </button>
                {selector && (
                  <div>
                    <button type="button" className="tk-select-drop-btn">
                      <span className="tk-select-drop-btn-info">
                        <img
                          ...
                          width="20px"
                        />
                        Avalanche<span className="">AVAX</span>
                      </span>
                      <div className="tk-select-drop-btn-price">
                        <div className="">$17.65</div>
                        <span className="">$17.65</span>
                      </div>
                    </button>
                  </div>
                )} */}
