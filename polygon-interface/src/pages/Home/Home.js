...
export default function Home({ showRedirectModal, redirectPopupTimestamp }) {
  ...
  // const faqContent = [{
  //   id: 1,
  //   question: "What is XDX?",
  //   answer: "XDX is a decentralized spot and perpetual exchange that supports low swap fees and zero price impact trades.<br><br>Trading is supported by a unique multi-asset pool that earns liquidity providers fees from market making, swap fees, leverage trading (spreads, funding fees & liquidations), and asset rebalancing.<br><br>Dynamic pricing is supported by Chainlink Oracles along with TWAP pricing from leading volume DEXs."
  // }, {
  //   id: 2,
  //   question: "What is the $XDX Governance Token? ",
  //   answer: "The $XDX token is the governance token of the $XDX ecosystem, it provides the token owner voting rights on the direction of the $XDX platform.<br><br>Additionally, when $XDX is staked you will earn 30% of the platform-generated fees, you will also earn Escrowed $XDX tokens and Multiplier Points."
  // }, {
  //   id: 3,
  //   question: "What is the $XLX Token? ",
  //   answer: "The $XLX token represents the liquidity users provide to the $XDX platform for Swaps and Margin Trading.<br><br>To provide liquidity to $XLX you <a href='https://xdx.io/buy_xlx' target='_blank'>trade</a> your crypto asset BTC, ETH, LINK, UNI, USDC, USDT, MIM, or FRAX to the liquidity pool, in exchange, you gain exposure to a diversified index of tokens while earning 50% of the platform trading fees and esXDX."
  // }, {
  //   id: 4,
  //   question: "What can I trade on XDX? ",
  //   answer: "On $XDX you can swap or margin trade any of the following assets: ETH, BTC, LINK, UNI, USDC, USDT, MIM, FRAX, with others to be added. "
  // }]
        ...
        <div className="Home-cta-container default-container">
          <div className="Home-cta-info">
            ...
            <div className="Home-cta-info__description">
              <Trans>$XDX is currently live on Arbitrum and Avalanche.</Trans>
            </div>
          </div>
      ...
      {/* <div className="Home-faqs-section">
        <div className="Home-faqs-container default-container">
          <div className="Home-faqs-introduction">
            ...
            <a href="https://xdx.gitbook.io/xdx/" className="default-btn Home-faqs-documentation">Documentation</a>
          </div>
