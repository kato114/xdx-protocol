...
import logoSmallImg from "img/logo_XDX_small.svg";
        ...
        <div className="App-header large">
          <div className="App-header-container-left">
            <Link className="App-header-link-main" to="/">
              <img src={logoImg} className="big" alt="XDX Logo" />
              <img src={logoSmallImg} className="small" alt="XDX Logo" />
            </Link>
        ...
        <div className={cx("App-header", "small", { active: isDrawerVisible })}>
          ...
          >
            <div className="App-header-container-left">
              ...
              <div className="App-header-link-main cursor-pointer" onClick={() => setIsDrawerVisible(!isDrawerVisible)}>
                <img src={logoImg} className="big" alt="XDX Logo" />
                <img src={logoSmallImg} className="small" alt="XDX Logo" />
              </div>
            </div>
