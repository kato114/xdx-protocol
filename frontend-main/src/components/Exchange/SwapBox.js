  ...
  return (
    <div className="relative grid xl:w-85">
      ...
      <div className="relative rounded px-4 py-2 text-sm">
            ...
            <div className="mb-2 rounded bg-slate-700 p-4 shadow">
              <div className="grid grid-cols-2 pb-4 text-sm">
                <div className="text-slate-300">
                  {fromUsdMin && (
                    <div className="Exchange-swap-usd text-sm">
          ...
          <div className="mb-[10.5px]">
            <div className="mb-2 text-[14px]">
              <Checkbox
                ...
                follow="right"
              >
                <span className="text-slate-400">Leverage slider</span>
              </Checkbox>
            </div>
        ...
        {isStopOrder && (
          <div className="mb-2 rounded bg-slate-700 p-4 text-xs font-medium">
        ...
        <div className="pt-[3.1px]">
          <button
            className="inline-block w-full cursor-pointer rounded bg-slate-800 p-3 text-center text-sm text-slate-300 hover:bg-indigo-500 disabled:cursor-not-allowed disabled:text-slate-500"
