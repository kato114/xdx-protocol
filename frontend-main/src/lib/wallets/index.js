  ...
  const fn = async () => {
    activate(getInjectedConnector(), (e) => {
      ...
      if (e instanceof UnsupportedChainIdError) {
        helperToast.error(
          <div>
            <div className="text-sm text-slate-300">Your wallet is not connected to {getChainName(chainId)}.</div>
            <br />
            <div
              className="margin-bottom cursor-pointer text-xs text-slate-300 underline"
