    ...
    return (
      <div>
        <div className="Exchange-list-tab-container">
          ...
          />
          <div className="Exchange-should-show-position-lines flex items-end justify-end text-end">
            {renderCancelOrderButton()}
            <Checkbox
              isChecked={savedShouldShowPositionLines}
              setIsChecked={setSavedShouldShowPositionLines}
              className={cx("chart-positions opacity-70", { active: savedShouldShowPositionLines })}
            >
              <span>
