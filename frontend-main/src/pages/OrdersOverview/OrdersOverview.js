...
export default function OrdersOverview() {
  ...
  return (
    <div className="Orders-overview">
      ...
      <p>
        <span className="text-green-500">Price conditions are met</span>
        <br />
        <span style={{ color: "orange" }}>Close to execution price</span>
        <br />
        <span className="text-[#fa3c58]">Can't execute because of an error</span>
      </p>
            ...
            if (type === SWAP) {
              ...
              return (
                <tr key={key}>
                  ...
                  <td className={cx({ "text-green-500": shouldExecute, near: !shouldExecute && nearExecute })}>
                    {!invalidToken && prefix}
                  ...
                  <td>{order.index}</td>
                  <td className="text-[#fa3c58]">{error}</td>
                  <td>
