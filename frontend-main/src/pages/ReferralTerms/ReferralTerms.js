          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the XDX Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the XDX DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the XDX DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the XDX DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, XDX DApp provides you with the Links and Referral Codes necessary to promote the
                XDX Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the XDX Protocol offers in any manner you choose unless it misleads someone about
                the XDX Protocol.
              </p>
              <p className="body-text">
                2.2 XDX.io is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause,
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the XDX tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                XDX.io is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
                are handled following the directives of the XDX tokenholders.
              </p>
              <p className="body-text">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://xdx.exchange/docs">
                  https://xdx.exchange/docs.
                </a>
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall XDX.io be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall XDX.io's aggregate liability arising out of or in connection with the Site exceed five
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by XDX.io, or your use of the service(s) provided by XDX.io, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from XDX.io, which the token holders of XDX determine. Due to
              ...
              <p className="body-text">
                XDX.io will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
                XDX.io may revise these Terms from time to time. We will notify you by updating the date at the top of
                the Terms and maintaining a current version. The most current version of the Terms will always be at
                https://XDX.io/referral-terms. All modifications will be effective when they are posted. By using the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and XDX.io concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. XDX.io will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. XDX.io may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 XDX.io will have no responsibility or liability for any failure or delay in performance of the Site,
