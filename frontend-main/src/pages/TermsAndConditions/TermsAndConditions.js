      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            ...
            <div className="text-sm text-slate-600">Last modified: August 1st, 2022</div>
          </div>
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to XDX.io ("we," "us," or "our"), the informational resource for XDX Protocol, as defined below.
              </p>
              <p className="body-text">
                XDX.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the XDX Protocol (the "XDX Protocol," "Protocol," or "XDX DApp"). XDX.io is not an
                available access point to the XDX Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access XDX.io ("the Site") and app.XDX.io ("the Interface"). Please do
            ...
            <div className="section">
              ...
              <p className="body-text">The XDX.io site is for informational purposes only.</p>
              <p className="body-text">
                XDX.io is not part of any transaction on the blockchain networks underlying the XDX Protocol; we do not
                ...
                any crypto assets. You understand that when you interact with any XDX Protocol smart contracts, you
                always retain control over your crypto assets. We do not have access to your private keys.
              </p>
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    1.1. As a condition to accessing or using the Site or Interface, you represent and warrant to XDX.io
                    the following:
                  </p>
                  <ul className="list-style-none">
                    <li>
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over XDX.io or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that XDX.io or any of its suppliers or contractors may undertake from time
                        to time; (c) causes beyond XDX.io's control or that XDX.io could not reasonably foresee; (d)
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with XDX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. XDX.io does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. XDX.io does not receive fees for any blockchain transactions or using the Site or the Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. XDX.io own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the XDX
                    Protocol and the Interface (app.XDX.io) deployed on IPFS is open-sourced. Except as expressly set
                ...
                <li>
                  <p className="body-text">
                    4.2. XDX.io may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that XDX.io is free to use or
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. XDX.io reserve the right, at our sole discretion, from time to time and with or without prior
                    ...
                    own its code. XDX.io will not be liable for any losses suffered by you resulting from any
                ...
                <li>
                  <p className="body-text">
                    5.2. XDX.io may revise these Terms from time to time. We will notify you by updating the date at the
                    top of the Terms and maintaining a current version. The most current version of the Terms will
                    always be at https://XDX.io/#/terms-and-conditions. All modifications will be effective when they
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. XDX.io does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That XDX.io is not responsible for the operation of the open-source software and networks
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither XDX.io nor any other person or entity will be able to retrieve
                ...
                <li>
                  <p className="body-text">
                    6.2. XDX.io is not responsible for the content of any third party, including, but not limited to,
                    information, materials, products, or services that XDX.io does not own or control. In addition,
                    third parties may offer promotions related to your access and use of the Interface. XDX.io does not
                    ...
                    You expressly relieve XDX.io of all liability arising from using such resources or participating in
                    such promotions.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that XDX.io will have no responsibility or liability for the risks
                    in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against XDX.io, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of XDX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including XDX.io's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                XDX.io is an informational site for the XDX Protocol. XDX.io does not operate an exchange platform or
              ...
              <p className="body-text">
                You understand that XDX.io is not registered or licensed by any regulatory agency or authority. No such
                agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. XDX.io
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall XDX.io, its affiliates, its suppliers and contractors, and its affiliates', suppliers'
                ...
                or the Interface, or other item provided by or on behalf of XDX.io, whether under contract, tort
                ...
                or any limited remedy hereunder nor is XDX.io in any way responsible for the execution or settlement of
                transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall XDX.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless XDX.io, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                XDX.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to XDX.io on any of our official channels. The notice must (a) describe the nature and
                basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar in
                form to that described above. If you and XDX.io cannot reach an agreement to resolve the claim within
                sixty (60) days of your email, then you and XDX.io agree to resolve the potential dispute according to
              ...
              <p className="body-text">
                ...
                year after such claim arose; otherwise, the claim is permanently barred, which means that you and XDX.io
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of XDX.io set forth in these Terms is in addition to, and not in lieu of,
                    any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of XDX.io in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. XDX.io will have no responsibility or liability for any failure or delay in performance of the
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and XDX.io and supersede all prior and
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with XDX.io
