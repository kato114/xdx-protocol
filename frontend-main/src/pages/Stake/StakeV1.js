        ...
        <div className="mb-2 rounded bg-slate-700 p-4 shadow">
          <div className="grid grid-cols-2 pb-[12.5px] text-[14px]">
            <div className="opacity-70">
              <div className="inline-block text-[14px]">Stake</div>
            </div>
            <div
              className="align-right cursor-pointer opacity-70"
          ...
          <div className="grid grid-cols-[1fr_auto] pb-[3.1px]">
            ...
            <div className="text-right text-[21px]">{stakingTokenSymbol}</div>
          </div>
        </div>
    ...
    <div className="StakeModal">
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <div className="mb-2 rounded bg-slate-700 p-4 shadow">
          <div className="grid grid-cols-2 pb-[12.5px] text-[14px]">
            <div className="opacity-70">
              <div className="inline-block text-[14px]">Unstake</div>
            </div>
            <div
              className="align-right cursor-pointer opacity-70"
              onClick={() => setValue(formatAmountFree(maxAmount, 18, 18))}
  ...
  return (
    <div className="Stake Page page-layout">
      ...
      <div className="App-warning Stake-warning">
        The <Link to="/migrate">XDX migration</Link> is in progress, please migrate your GMT, xGMT, GMT-USDG and
        xGMT-USDG tokens.
        <br />
