...
export function getTokenInfo(
  ...
  return infoTokens[ethers.utils.getAddress(tokenAddress)];
}

export function getLowestFeeTokenForBuyXlx(
  chainId: number,
  toAmount: BigNumber,
  xlxPrice: BigNumber,
  ...
  if (!chainId || !toAmount || !infoTokens || !xlxPrice || !usdgSupply || !totalTokenWeights || !swapUsdMin) {
    return;
  }
