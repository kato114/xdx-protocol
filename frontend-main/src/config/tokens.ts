...
export const TOKENS: { [chainId: number]: Token[] } = {
  ...
  [AVALANCHE]: [
    {
      ...
      isShortable: true,
      imageUrl:
        "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/avax.svg",
    },
    {
      name: "Wrapped AVAX",
      symbol: "WAVAX",
  ...
  [AVALANCHE_TESTNET]: [
    ...
    },
    {
      ...
      symbol: "WAVAX",
      decimals: 18,
      address: "0x90D2753010931972e7cb30b2fBFD1194E015104e",
      isWrapped: true,
      baseSymbol: "AVAX",
      imageUrl:
        "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/avax.svg",
    },
    {
      name: "Ethereum (WETH.e)",
      symbol: "ETH",
      address: "0x49E33813642F0C2f8A554BF08a77423e14708991",
      decimals: 18,
      isShortable: true,
      imageUrl:
        "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/eth.svg",
    },
    {
      name: "Bitcoin (WBTC.e)",
      symbol: "BTC",
      address: "0xd25b967b82C53d192B74Dc1f474f409A5694aC73",
      decimals: 8,
      isShortable: true,
      imageUrl:
        "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/btc.svg",
    },
    {
      name: "Bitcoin (BTC.b)",
      symbol: "BTC.b",
      address: "0x0648dABe12544bEe6415d3621a8D10b1A73FC899",
      decimals: 8,
      isShortable: false,
      imageUrl:
        "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/btc.svg",
    },
    {
      name: "USD Coin (USDC.e)",
      symbol: "USDC.e",
      address: "0xBdefaB5f5A706FD2920FEd55431528163C8B34C4",
      decimals: 6,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
    },
    {
      name: "USD Coin",
      symbol: "USDC",
      address: "0xe1Dbb660AEb83c728cf50697C0fB45971689CBC0",
      decimals: 6,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
    },
    ...
    //   name: "Magic Internet Money",
    //   symbol: "MIM",
    //   address: "0xc6672Fc5be39CEdb6a9992d7Ae76b0bBfD2B72E4",
    //   decimals: 18,
    //   isStable: true,
    //   isTempHidden: true,
    //   imageUrl: "https://assets.coingecko.com/coins/images/16786/small/mimlogopng.png",
...
export const ADDITIONAL_TOKENS: { [chainId: number]: Token[] } = {
  ...
  //     name: "XDX",
  //     symbol: "XDX",
  //     address: getContract(ARBITRUM, "XDX"),
  //     decimals: 18,
  ...
  //     name: "Escrowed XDX",
  //     symbol: "esXDX",
  //     address: getContract(ARBITRUM, "EsXDX"),
  //     decimals: 18,
  //   },
  //   {
  //     name: "XDX LP",
  //     symbol: "XLX",
  //     address: getContract(ARBITRUM, "XLX"),
  //     decimals: 18,
  ...
  [AVALANCHE]: [
    ...
    },
    {
      name: "Escrowed XDX",
      symbol: "esXDX",
      address: getContract(AVALANCHE, "EsXDX"),
      decimals: 18,
    },
    {
      name: "XDX LP",
  ...
  [AVALANCHE_TESTNET]: [
    {
      name: "XDX",
      symbol: "XDX",
      address: getContract(AVALANCHE_TESTNET, "XDX"),
      decimals: 18,
      imageUrl: "https://assets.coingecko.com/coins/images/18323/small/arbit.png?1631532468",
    },
    {
      name: "Escrowed XDX",
      symbol: "esXDX",
      address: getContract(AVALANCHE_TESTNET, "EsXDX"),
      decimals: 18,
    },
    {
      name: "XDX LP",
      symbol: "XLX",
      address: getContract(AVALANCHE_TESTNET, "XLX"),
      decimals: 18,
      imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  ],
...
export const PLATFORM_TOKENS: { [chainId: number]: { [symbol: string]: Token } } = {
  ...
  //     symbol: "XLX",
  //     decimals: 18,
  //     address: getContract(ARBITRUM, "StakedXlxTracker"),
  //     imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
  //   },
  // },
  [AVALANCHE]: {
  ...
  [AVALANCHE_TESTNET]: {
    // avalanche_TESTAVALANCHE_TESTNET
    XDX: {
      name: "XDX",
      symbol: "XDX",
      decimals: 18,
    ...
    XLX: {
      ...
      symbol: "XLX",
      decimals: 18,
      address: getContract(AVALANCHE_TESTNET, "StakedXlxTracker"),
      imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  },
};
...
export const ICONLINKS = {
  ...
  [AVALANCHE_TESTNET]: {
    XDX: {
      coingecko: "https://www.coingecko.com/en/coins/xdx",
      avalanche: "https://testnet.snowtrace.io/address/0x256A8Af2a328781eC08ebE16949B4AeBA8c90901",
    },
    XLX: {
      avalanche: "https://testnet.snowtrace.io/address/0xA288Fb6a088816Eb2E71E99C4c839d422f75297A",
    },
    AVAX: {
      coingecko: "https://www.coingecko.com/en/coins/avalanche",
    },
    ETH: {
      coingecko: "https://www.coingecko.com/en/coins/weth",
      avalanche: "https://testnet.snowtrace.io/address/0x49E33813642F0C2f8A554BF08a77423e14708991",
    },
    BTC: {
      coingecko: "https://www.coingecko.com/en/coins/wrapped-bitcoin",
      avalanche: "https://testnet.snowtrace.io/address/0xd25b967b82C53d192B74Dc1f474f409A5694aC73",
    },
    "BTC.b": {
      coingecko: "https://www.coingecko.com/en/coins/wrapped-bitcoin",
      avalanche: "https://testnet.snowtrace.io/address/0x0648dABe12544bEe6415d3621a8D10b1A73FC899",
    },
    // MIM: {
    //   coingecko: "https://www.coingecko.com/en/coins/magic-internet-money",
    //   avalanche: "https://testnet.snowtrace.io/address/0x130966628846bfd36ff31a822705796e8cb8c18d",
    // },
    "USDC.e": {
      coingecko: "https://www.coingecko.com/en/coins/usd-coin-avalanche-bridged-usdc-e",
      avalanche: "https://testnet.snowtrace.io/address/0xBdefaB5f5A706FD2920FEd55431528163C8B34C4",
    },
    USDC: {
      coingecko: "https://www.coingecko.com/en/coins/usd-coin",
      avalanche: "https://testnet.snowtrace.io/address/0xe1Dbb660AEb83c728cf50697C0fB45971689CBC0",
    },
  },
};

export const XLXPOOLCOLORS = {
  ETH: "#6062a6",
  BTC: "#F7931A",
  "BTC.b": "#F7931A",
  USDC: "#2775CA",
...
const CHAIN_IDS = [
  // MAINNET, TESTNET, ARBITRUM, ARBITRUM_TESTNET,
  AVALANCHE,
  AVALANCHE_TESTNET,
];
